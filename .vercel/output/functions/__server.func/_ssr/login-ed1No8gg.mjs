...
//#region node_modules/.nitro/vite/services/ssr/assets/login-ed1No8gg.js
...
function Login() {
	return /* @__PURE__ */ (0, import_jsx_runtime.jsx)("main", {
		...
		children: /* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
			className: "w-full max-w-sm space-y-5 rounded-xl border border-border bg-surface p-6",
			children: [
				/* @__PURE__ */ (0, import_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, import_jsx_runtime.jsx)("p", {
							...
							children: "Save your high score identity when deployed."
						})
					]
				}),

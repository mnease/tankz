...
//#region node_modules/.nitro/vite/services/ssr/assets/router-DEP8JLph.js
...
var styles_default = "/assets/styles-Bm-aH7d4.css";
var APP_NAME = "Tankz";
var Route$3 = createRootRoute({
	head: () => ({
		meta: [
			...
			{
				name: "description",
				content: "Modern top-down tank combat. Drive, rotate, blast enemy armor."
			},
			...[]
		],
		links: [{
...
var $$splitComponentImporter$1 = () => import("./routes-CwaREZTp.mjs");
var Route$2 = createFileRoute("/")({ component: lazyRouteComponent($$splitComponentImporter$1, "component") });
var $$splitComponentImporter = () => import("./login-ed1No8gg.mjs");
